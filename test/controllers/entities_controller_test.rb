...
class EntitiesControllerTest < ActionController::TestCase
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post :create, entity: { classification: @entity.classification, logo: @entity.logo, name: @entity.name }
    end
  ...
  test "should update entity" do
    patch :update, id: @entity, entity: { classification: @entity.classification, logo: @entity.logo, name: @entity.name }
    assert_redirected_to entity_path(assigns(:entity))
  end
